...
//     let rolesList = this.getRolesList(),
//       selectRender = [],
//       options = [];
...
//         controlId="rolSelect"
//         label="Rol"
//         validationMessage={this.state.formSelect.mensaje}
//         inputComponent={
//           <Select
//             key="rolSelect"
//             name="rolSelect"
...
//             this.props.agregarRol(
//               this.props.idUsuario,
//               this.state.rolSeleccionado
//             );
...
//     return (
//       <p>
//         ¿Seguro querés eliminar el rol{' '}
//         {this.getNombreRolById(this.state.rolBorrarClickeado)}?
//       </p>
//     );
//   }
...
//         bsSize="small"
//         onClick={() => {
//           this.props.removeRol(
//             this.props.idUsuario,
//             this.state.rolBorrarClickeado
//           );
...
//     this.props.activeUser.roles.forEach((element) => {
//       if (element.id == id) {
...
//       return (
//         <CustomTable
//           data={this.props.activeUser.roles}
//           headers={['Nombre', 'Descripción']}
//           deleteAction={this.abrirModalBorrarRol}
//         />
//       );
//     }
...
//                 onClick={this.abrirModalAgregarRol}
//               >
...
//           key="borrarRolModal"
//           title="Borrar rol"
//           body={this.getBorrarRolModalBody()}
//           buttons={this.getBorrarRolModalButtons()}
//           ref={(modalBorrarRol) => {
//             this.modalBorrarRol = modalBorrarRol;
//           }}
//         />
//         <CustomModal
//           key="agregarRolModal"
...
//           buttons={this.getAgregarRolModalButtons()}
//           ref={(modalAgregarRol) => {
//             this.modalAgregarRol = modalAgregarRol;
//           }}
//         />
//       </div>
//     );
