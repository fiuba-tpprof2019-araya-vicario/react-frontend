...
import { getProject, abandonIdea, clearAlert } from './ideasReducer';
  ...
  render() {
    ...
    return (
      <Fragment>
        <Row>
          <Title
            title={ideasMessages.TITLE}
            subtitle={ideasMessages.SUBTITLE}
          />
        ...
        {this.state.activeStep === 1 ? (
          <ShowIdea
            nextStepMessage={ideasMessages.NEW_STEP_PROJECT_CREATED_INFO}
            showBackButton
            project={project}
            userId={user.id}
          />
        ...
        {this.state.activeStep === 2 ? (
          <ShowIdea
            nextStepMessage={ideasMessages.NEW_STEP_PROJECT_ACCEPTED_INFO}
            showBackButton
            showProposal
            showAbandonButton
            project={project}
